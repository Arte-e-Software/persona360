...
Path: ./back_end/build/Tenant/search.js
...
*/
    ...
    ,Model_search = require('../../../entity/Tenant/model/search')
...
return res.status(500).send({ erro: 'Erro em Entity: Tenant Layer: controller Module: search.js' });
