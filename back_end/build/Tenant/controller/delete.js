...
Path: ./back_end/build/Tenant/delete.js
...
*/
 ...
 idTenant: req.params.idTenant,idPessoa: req.params.idPessoa}
    ...
    erro = !params.idTenant===!params.idPessoa;

if (erro) {

return res.status(500).send({ erro: 'Erro em Entity: Tenant Layer: controller Module: delete.js' });
