...
var dealJson = function (jsonObj) {
    ...
    for (i = 0; i < jsonObj.length; i++) {
        ...
        newRow += '<td>' + email + '</td>';
        newRow += '<td>';
        newRow += '<button class="btn btn-outline-success my-2 my-sm-0" onclick=" confirmaAtivacao(' + id + ',\'' + email + '\',\'' + cupom +'\');"> Ativar </button>';
        newRow += '</td>';
        newRow += '</tr>';
...
var confirmaAtivacao = function (id, email, cupom) {
